...
- 🧾 **Runs + evidence** — every execution attempt is a run with phase reports, blockers, and attached PR / test / artifact URLs; self-reported evidence stays in review until a human accepts it.
